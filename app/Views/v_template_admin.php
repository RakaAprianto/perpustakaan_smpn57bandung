            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <?php
                        if ($user['level'] == 0) {
                            echo '<a class="text-success"><i class="fas fa-check-circle"></i></i> Admin</a>';
                        } else {
                            echo '<a class="text-primary"><i class="fas fa-check-circle"></i></i> Petugas</a>';
                        }
                        ?>
                    </div>
                </div>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/PengajuanMasuk') ?>"
                                        class="nav-link <?= $submenu == 'pengajuanmasuk' ? 'active' : '' ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/PengajuanDiterima') ?>"
                                        class="nav-link <?= $submenu == 'pengajuanditerima' ? 'active' : '' ?>">
                                        <i class="fas fa-circle nav-icon "></i>
                                        <p>Diterima</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/PengajuanDitolak') ?>"
                                        class="nav-link <?= $submenu == 'pengajuanditolak' ? 'active' : '' ?>">
                                        <i class="fas fa-circle nav-icon "></i>
                                        <p>Ditolak</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Admin/PengajuanDikembalikan') ?>"
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Penulis') ?>"
                                        class="nav-link <?= $submenu == 'penulis' ? 'active' : '' ?>">
                                        <i class="fas fa-circle nav-icon"></i>
                                        <p>Penulis</p>
                                    </a>
                                </li>
                        ...
                        <?php if (session()->get('level') == "0") { ?>
                            ...
                            <li class="nav-item <?= $menu == 'pengaturan' ? 'menu-open' : '' ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?= base_url('Pengaturan/Slider') ?>"
                                            class="nav-link <?= $submenu == 'slider' ? 'active' : '' ?>">
                                            <i class="fas fa-circle nav-icon"></i>
                                            <p>Slider</p>
                                        </a>
                                    </li>
    ...
    <script>
        $(function() {
            ...
            $("#tabelhistory").DataTable({
                ...
                "autoWidth": true,
                "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
            }).buttons().container().appendTo('#tabelhistory_wrapper .col-md-6:eq(0)');
        });
    </script>
