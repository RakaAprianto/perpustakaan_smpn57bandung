            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>NIS</label>
                            <input class="form-control" name="nis" value="<?= $anggota['nis'] ?>"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password"
                                        value="<?= $anggota['password'] ?>" placeholder="Masukan Password">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="<?= base_url('DashboardAnggota') ?>" class="btn btn-warning btn-flat">Kembali</a>
                </div>
            </div>
            <?php echo form_close() ?>
        </div>
