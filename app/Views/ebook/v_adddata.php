<div class="col-md-12">
        ...
        <div class="card-body">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>Halaman</label>
                                <input type="number" class="form-control" name="halaman" value="<?= old('halaman') ?>"
                                    placeholder="Halaman">
                            </div>
                        </div>
                        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="" class="form-control" rows="5"><?= old('deskripsi') ?>"</textarea>
                </div>
            </div>
    ...
    <div class="card-footer">
        ...
        <a href="<?= base_url('Ebook') ?>" class="btn btn-warning"><i class="fas fa-undo-alt"></i> Kembali</a>
    </div>
    <?php echo form_close() ?>
</div>
</div>